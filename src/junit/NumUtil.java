...
public interface NumUtil {
	 ...
	 * 
	 * @param values A variable number of values. The valid range of possible values
	 *               is between 2 and 12.
	 * 
	 * @return The minimum value.
	 *
	 * @throws IllegalArgumentException If the number of values is less than 2 or
	 *                                  greater than 12.
	 */
	 ...
	 * 
	 * @param values A variable number of values. The valid range of * possible
	 *               values is between 1 and 100.
	 * 
	 * @return The sum.
	 *
	 * @throws IllegalArgumentException In case of an invalid value range.
	 */
